		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">报名日期</div>
						<div class="text "  >{{detail.baomingriqi}}</div>
					</div>
					<div class="item">
						<div class="lable">结束日期</div>
						<div class="text "  >{{detail.jieshuriqi}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						...
						<el-button class="reserveBtn" 
							v-if="btnAuth('bisaixinxi','报名')" 
							@click="onAcross('baomingbisai','','','[1]','已报名')" type="warning">
							报名
						</el-button>
					</div>
				</div>
			...
			<div class="detail2">
				<div class="desc-view">
					<div class="desc-label">比赛详情</div>
				</div>
				<div class="desc-text ql-snow ql-editor" v-html="detail.bisaixiangqing"></div>
			</div>
	...
	export default {
		...
		methods: {
			...
			storeup(type) {
				...
				if (type == -1 && this.isStoreup) {
					this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'bisaixinxi', userid: localStorage.getItem('frontUserid')}}).then(res => {
