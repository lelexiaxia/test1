<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"#fff","width":"1400px","fontSize":"16px","position":"relative"}'>
		<div class="back_box">
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0","borderColor":"#1A3194","margin":"0 0 20px 0","color":"#1A3194","textAlign":"center","background":"none","borderWidth":"1px 0","width":"100%","lineHeight":"50px","fontSize":"24px","borderStyle":"solid"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"padding":"10px 0","margin":"20px auto","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"left","width":"100%","clear":"both","fontSize":"16px","fontWeight":"500","order":"50"}'
