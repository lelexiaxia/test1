		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.duizhanxuanshou" placeholder="对战选手" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">玩家姓名：</div>
					<el-input v-model="formSearch.wanjiaxingming" placeholder="玩家姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('duizhananpai','新增')" type="primary" @click="add('/index/duizhananpaiAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.duizhanxuanshou != '') searchWhere.duizhanxuanshou = '%' + this.formSearch.duizhanxuanshou + '%';
				if (this.formSearch.wanjiaxingming != '') searchWhere.wanjiaxingming = '%' + this.formSearch.wanjiaxingming + '%';
				let user = JSON.parse(localStorage.getItem('sessionForm'))
				if (this.sortType) searchWhere.sort = this.sortType
				if (this.sortOrder) searchWhere.order = this.sortOrder
				this.$http.get(`duizhananpai/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/duizhananpaiDetail', query: params});
			},
