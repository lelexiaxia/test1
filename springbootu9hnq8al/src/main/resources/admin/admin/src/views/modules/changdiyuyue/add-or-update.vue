	...
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-else-if="ruleForm.yuyuebeizhu" label="预约备注" prop="yuyuebeizhu" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.yuyuebeizhu"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yuyuebeizhu = this.ruleForm.yuyuebeizhu.replace(reg,'../../../springbootu9hnq8al/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
