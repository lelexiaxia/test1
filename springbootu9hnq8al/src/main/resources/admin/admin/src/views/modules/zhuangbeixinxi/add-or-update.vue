	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="装备分类" prop="zhuangbeifenlei" >
					<el-select :disabled="ro.zhuangbeifenlei" v-model="ruleForm.zhuangbeifenlei" placeholder="请选择装备分类" >
						<el-option
				...
				<el-form-item v-else class="input" label="装备分类" prop="zhuangbeifenlei" >
					<el-input v-model="ruleForm.zhuangbeifenlei"
						placeholder="装备分类" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="装备数量" prop="zhuangbeishuliang" >
					<el-input v-model.number="ruleForm.zhuangbeishuliang" placeholder="装备数量" clearable  :readonly="ro.zhuangbeishuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="装备数量" prop="zhuangbeishuliang" >
					<el-input v-model="ruleForm.zhuangbeishuliang" placeholder="装备数量" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="装备型号" prop="zhuangbeixinghao" >
					<el-input v-model="ruleForm.zhuangbeixinghao" placeholder="装备型号" clearable  :readonly="ro.zhuangbeixinghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="装备型号" prop="zhuangbeixinghao" >
					<el-input v-model="ruleForm.zhuangbeixinghao" placeholder="装备型号" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="装备详情" prop="zhuangbeixiangqing" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.zhuangbeixiangqing" label="装备详情" prop="zhuangbeixiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.zhuangbeixiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.zhuangbeixiangqing = this.ruleForm.zhuangbeixiangqing.replace(reg,'../../../springbootu9hnq8al/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `zhuangbeixinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zhuangbeixinxiCrossAddOrUpdateFlag = false;
											this.parent.search();
