	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="场地规模" prop="changdiguimo" >
					<el-input v-model="ruleForm.changdiguimo" placeholder="场地规模" clearable  :readonly="ro.changdiguimo"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="场地规模" prop="changdiguimo" >
					<el-input v-model="ruleForm.changdiguimo" placeholder="场地规模" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.kaifangshijian" label="开放时间" prop="kaifangshijian" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="场地设施" prop="changdisheshi" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.changdisheshi" label="场地设施" prop="changdisheshi" >
				<span class="text">{{ruleForm.changdisheshi}}</span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.changdixiangqing = this.ruleForm.changdixiangqing.replace(reg,'../../../springbootu9hnq8al/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
