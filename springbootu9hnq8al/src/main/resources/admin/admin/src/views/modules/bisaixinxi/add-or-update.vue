	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.baomingriqi" label="报名日期" prop="baomingriqi" >
				...
				<el-form-item class="input" v-else-if="ruleForm.jieshuriqi" label="结束日期" prop="jieshuriqi" >
			...
			<el-form-item v-else-if="ruleForm.bisaixiangqing" label="比赛详情" prop="bisaixiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.bisaixiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.bisaixiangqing = this.ruleForm.bisaixiangqing.replace(reg,'../../../springbootu9hnq8al/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
