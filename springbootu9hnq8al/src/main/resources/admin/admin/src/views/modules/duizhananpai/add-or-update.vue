	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="比赛场次" prop="bisaichangci" >
					<el-input v-model="ruleForm.bisaichangci" placeholder="比赛场次" clearable  :readonly="ro.bisaichangci"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="比赛场次" prop="bisaichangci" >
					<el-input v-model="ruleForm.bisaichangci" placeholder="比赛场次" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="对战选手" prop="duizhanxuanshou" >
					<el-input v-model="ruleForm.duizhanxuanshou" placeholder="对战选手" clearable  :readonly="ro.duizhanxuanshou"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="对战选手" prop="duizhanxuanshou" >
					<el-input v-model="ruleForm.duizhanxuanshou" placeholder="对战选手" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.anpaishijian" label="安排时间" prop="anpaishijian" >
			...
			<el-form-item v-if="type!='info'"  label="对战安排" prop="duizhananpai" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.duizhananpai" 
					class="editor" 
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.duizhananpai" label="对战安排" prop="duizhananpai" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.duizhananpai"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='bisaichangci'){
							this.ruleForm.bisaichangci = obj[o];
							this.ro.bisaichangci = true;
							continue;
						}
						if(o=='duizhanxuanshou'){
							this.ruleForm.duizhanxuanshou = obj[o];
							this.ro.duizhanxuanshou = true;
							continue;
						}
						if(o=='anpaishijian'){
						...
						if(o=='duizhananpai'){
							this.ruleForm.duizhananpai = obj[o];
							this.ro.duizhananpai = true;
							continue;
						}
						if(o=='wanjiazhanghao'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.duizhananpai = this.ruleForm.duizhananpai.replace(reg,'../../../springbootu9hnq8al/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `duizhananpai/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.duizhananpaiCrossAddOrUpdateFlag = false;
											this.parent.search();
